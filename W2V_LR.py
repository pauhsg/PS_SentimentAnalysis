...
training_sequences,train_word_index,train_lr_data = get_sequences_idx_padding(tokenizer,data_train,MAX_SEQUENCE_LENGTH)
...
Test_sequences,Test_word_idx,Test_lr = get_sequences_idx_padding(tokenizer,test_df,MAX_SEQUENCE_LENGTH)

r_y_pred = clf.predict(Test_lr)

#CREATE SUBMISSION
test_id = test_df['Tweet_submission_id'].to_numpy()
create_csv_submission(test_id,r_y_pred, "./Submissions/LR_W2V_SUB.csv")